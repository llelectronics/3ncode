        ...
        TextEdit {
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    selectStart = textEdit.selectionStart;
                    selectEnd = textEdit.selectionEnd;
                    curPos = textEdit.cursorPosition;
                    contextMenu.open(mouse.x, mouse.y);
                    textEdit.cursorPosition = curPos;
                    textEdit.select(selectStart,selectEnd);
                }
            }
        }
    }
